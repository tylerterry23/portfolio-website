...
typewriter.typeString('hey, welcome!')
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is Tyler.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a student at Western Michigan.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm also interested in weightlifting.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like to play read.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
